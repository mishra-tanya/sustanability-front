...
doc.text(`"${selectedQuote}"`, pageWidth / 2, 150, {
  ...
  maxWidth: 280,
    ...
    setFont(false, 16);
    wrapText(
      `of  ${userSchool}, Class group ${classGroup} for successfully participating in the Sustainability Olympiad Event organized by the SustainabilityOlympiad.org. We appreciate your presence and wish you all the best for future endeavors.`,
      canvas.width/2 ,
      350,
      600,
      20
